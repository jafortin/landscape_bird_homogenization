...
historicdata <- read_xlsx(here("SupplementaryData","ImageAnalysis.xlsx"), sheet="Historic") %>%
  mutate(TIME = "Historic")
repeatdata <- read_xlsx(here("SupplementaryData","ImageAnalysis.xlsx"), sheet="Repeat") %>%
  mutate(TIME = "Repeat")
...
landcovertypes <- read.csv(here("SupplementaryData", "LandcoverLookup.csv"))
species <- read.csv(here("SupplementaryData", "SpeciesLookup.csv")) %>%
...
sonab <- read_xlsx(here("SupplementaryData","assessment-table-full.xlsx"), sheet="SONAB database for distribution") %>%
...
historicdata_lb <- read_xlsx(here("SupplementaryData","ImageAnalysis_SensitivityAnalysis_MinusSE.xlsx"), sheet="Historic") %>%
  mutate(TIME = "Historic")
repeatdata_lb <- read_xlsx(here("SupplementaryData","ImageAnalysis_SensitivityAnalysis_MinusSE.xlsx"), sheet="Repeat") %>%
  mutate(TIME = "Repeat")
...
historicdata_ub <- read_xlsx(here("SupplementaryData","ImageAnalysis_SensitivityAnalysis_PlusSE.xlsx"), sheet="Historic") %>%
  mutate(TIME = "Historic")
repeatdata_ub <- read_xlsx(here("SupplementaryData","ImageAnalysis_SensitivityAnalysis_PlusSE.xlsx"), sheet="Repeat") %>%
  mutate(TIME = "Repeat")
...
ggsave(plot = plot5, file = "./FigS2b.png",
       type = "cairo-png",  bg = "transparent",
       width = 20, height = 15, units = "cm", dpi = 300)
